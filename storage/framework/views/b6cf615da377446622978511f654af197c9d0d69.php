...
unset($__errorArgs, $__bag); ?>" name="dob" value="<?php echo e(old('dob')); ?>" required autocomplete="dob" autofocus placeholder=" DD/MM/YYYY">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="register__two">
                <div class="entry">
                    <input id="profile_pic" type="file" class="form-control <?php $__errorArgs = ['profile_pic'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="profile_pic" value="<?php echo e(old('profile_pic')); ?>" required autocomplete="profile_pic" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\assignment02\resources\views/auth/register.blade.php ENDPATH**/ ?>