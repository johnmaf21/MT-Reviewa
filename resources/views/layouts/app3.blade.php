...
<div id="app">
    <div class="header">
        <a class="logo" href="/">
            <img src="{{ asset('images/transparentLogo4.png') }}" alt="home">
        </a>
        <nav>
            <!-- Links -->
            @if(Auth::guest())
...
<script type="text/javascript" src="https://s7.addthis.com/js/300/addthis_widget.js#pubid=ra-61e82b92fb4276df"></script>
</body>
</html>
